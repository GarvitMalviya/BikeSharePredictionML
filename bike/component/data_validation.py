...
class DataValidation:
    ...
    def get_train_and_test_df(self) -> tuple[Any, Any]:
        try:
    ...
    def is_train_test_file_exist(self) -> Union[bytes, str]:
        try:
            logging.info("if train and test file is available")
    ...
    def validate_dataset_schema(self, schema_file_path, file_path) -> bool:
        try:
            ...
            schema_season_values = dataset_schema[DATASET_DOMAIN_VALUE_KEY][DATASET_SEASON_DOMAIN_VALUE]
